...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="home">Book</a>
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted mb-0">Thế giới quả là rộng lớn và còn rất nhiều việc phải làm</p>
            </div>
        </section>
        <!--end of menu-->
                                ...
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        <div class="img-big-wrap">
                                            <div> <a href="#"><img src="${detail.imageUrl}"></a></div>
                                        </div> <!-- slider-product.// -->
