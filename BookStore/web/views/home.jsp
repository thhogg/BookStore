...
<html>
    ...
    <body>
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Sách là bạn</h1>
                <p class="lead text-muted mb-0">Thế giới quả là rộng lớn và còn nhiều điều mới mẻ.</p>
            </div>
        </section>
        <!--end of menu-->
        <div class="container">
                        ...
                        <c:forEach items="${listB}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="detail?pid=${o.bookID}" title="View Product">${o.title}</a></h4>
